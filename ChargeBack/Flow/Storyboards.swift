...
struct Storyboards {
    ...
    struct ChargeBack: Storyboard {

        static let identifier = "ChargeBack"

        static var storyboard: UIStoryboard {
            return UIStoryboard(name: self.identifier, bundle: ChargeBackInstance.bundle())
        }
...
extension UIStoryboardSegue {
    func selection() -> NoticeViewController.Segue? {
        if let identifier = self.identifier {
            return NoticeViewController.Segue(rawValue: identifier)
        }
        return nil
    }
}
...
extension NoticeViewController { 
    ...
    enum Segue: String, CustomStringConvertible, SegueProtocol {
        case presentChargeBack = "presentChargeBack"

        var kind: SegueKind? {
            switch (self) {
            case .presentChargeBack:
        ...
        var destination: UIViewController.Type? {
            switch (self) {
            case .presentChargeBack:
                return ChargeBackViewController.self
            }
        }
...
//MARK: - ChargeBackViewController
extension UIStoryboardSegue {
    func selection() -> ChargeBackViewController.Segue? {
        if let identifier = self.identifier {
            return ChargeBackViewController.Segue(rawValue: identifier)
        }
        return nil
    }
}
...
extension ChargeBackViewController { 
    ...
    enum Segue: String, CustomStringConvertible, SegueProtocol {
        case presentResult = "presentResult"
        ...
        var destination: UIViewController.Type? {
            switch (self) {
            case .presentResult:
                return ResultViewController.self
            }
        }
